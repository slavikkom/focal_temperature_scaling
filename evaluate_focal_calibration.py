...
link_dict = {
    ...
    'focal_linear': [-0.9, -0.7, -0.5, -0.3, -0.1, 0.1, 0.3, 0.5, 0.7, 0.9], # [0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7],
    'exp_p': [0.1, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 2, 3], # [0.5, 0.75, 1, 1.5, 2],#[0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7],
    'exp_1mp': [-2, -1, -0.5, -0.25, 0.25, 0.5, 1, 1.5, 2.0], # [0.5, 1, 1.25, 1.5, 2],#[0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7],
    'one_minus_power': [0.25, 0.5, 0.75, 1.25, 1.5, 2, 2.5, 3, 5], # [0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7],
    'generalized_focal': [(b, g) for b in [0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7] for g in [0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7]],
    'log_power': [0.1, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 2, 3] # [0.25, 0.5, 0.75, 1, 1.5, 2, 3, 5, 7]
}
