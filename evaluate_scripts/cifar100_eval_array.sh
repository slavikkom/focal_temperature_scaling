...
# sbatch --array=0-<total_jobs> cifar100_slurm_array2.job

#SBATCH --job-name=eval_cf100
#SBATCH --output=slurm_logs_cifar100/eval_job_%A_%a.out
...
EVAL_BASE="../RESULTS/CIFAR100_epoch${EPOCH}"
