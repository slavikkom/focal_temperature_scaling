#!/bin/bash
# Run TissueMNIST post-hoc calibration from saved logits.
# Submit after tissuemnist_save_logits_array.sh with:
# sbatch --array=0-<total_jobs_minus_1> tissuemnist_posthoc_array.sh

#SBATCH --job-name=posthoc_tissue
#SBATCH --output=slurm_logs_tissuemnist_july17/posthoc_job_%A_%a.out
...
LOGITS_BASE="../RESULTS/july26/TISSUEMNIST_LOGITS_epoch${EPOCH}"
# EVAL_BASE="../RESULTS/july26/TISSUEMNIST_POSTHOC_epoch${EPOCH}"
# EVAL_BASE="../RESULTS/july26/TISSUEMNIST_POSTHOC_TEMPERATURE_FIRST_epoch${EPOCH}"
EVAL_BASE="../RESULTS/july26/TISSUEMNIST_POSTHOC_TEMPERATURE_LAST_epoch${EPOCH}"
