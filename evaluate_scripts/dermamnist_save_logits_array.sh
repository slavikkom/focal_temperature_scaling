#!/bin/bash
# Save DermMNIST train/val/test logits without running post-hoc calibration.
# Submit with:
# sbatch --array=0-<total_jobs_minus_1> dermamnist_save_logits_array.sh

#SBATCH --job-name=logits_derma
#SBATCH --output=slurm_logs_dermamnist_lr05/logits_job_%A_%a.out
...
SAVE_BASE="../MODEL_DIRECTORY/DERMAMNIST_LR05"
