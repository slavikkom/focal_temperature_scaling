#!/bin/bash
# Save CIFAR-100-C train/val/test logits without running post-hoc calibration.
# Submit with:
# sbatch --array=0-<total_jobs_minus_1> cifar100c_save_logits_array.sh

#SBATCH --job-name=logits_cf100c
#SBATCH --output=slurm_logs_cifar100c/logits_job_%A_%a.out
...
SAVE_BASE="../MODEL_DIRECTORY/CIFAR100"
