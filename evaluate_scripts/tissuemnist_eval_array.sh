...
# sbatch --array=0-<total_jobs> tissue_slurm_array.job

#SBATCH --job-name=eval_tissuemnist
#SBATCH --output=slurm_logs_tissuemnist/eval_job_%A_%a.out
...
EVAL_BASE="../RESULTS/TISSUEMNIST_epoch${EPOCH}"
