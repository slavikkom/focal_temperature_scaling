#!/bin/bash
# Run OCTMNIST post-hoc calibration from saved logits.
# Submit after octmnist_save_logits_array.sh with:
# sbatch --array=0-<total_jobs_minus_1> octmnist_posthoc_array.sh

#SBATCH --job-name=posthoc_oct
#SBATCH --output=slurm_logs_octmnist_lr05_july17/posthoc_job_%A_%a.out
...
LOGITS_BASE="../RESULTS/july26/OCTMNIST_LR05_LOGITS_epoch${EPOCH}"
# EVAL_BASE="../RESULTS/july26/OCTMNIST_LR05_POSTHOC_epoch${EPOCH}"
# EVAL_BASE="../RESULTS/july26/OCTMNIST_POSTHOC_TEMPERATURE_FIRST_epoch${EPOCH}"
EVAL_BASE="../RESULTS/july26/OCTMNIST_POSTHOC_TEMPERATURE_LAST_epoch${EPOCH}"
