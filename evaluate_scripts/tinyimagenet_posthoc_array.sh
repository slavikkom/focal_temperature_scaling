#!/bin/bash
# Run TinyImageNet post-hoc calibration from saved logits.
# Submit after tinyimagenet_save_logits_array.sh with:
...
EVAL_BASE="../RESULTS/TINYIMAGENET_POSTHOC_epoch${EPOCH}"
