#!/bin/bash
# Save TissueMNIST train/val/test logits without running post-hoc calibration.
# Submit with:
# sbatch --array=0-<total_jobs_minus_1> tissuemnist_save_logits_array.sh

#SBATCH --job-name=logits_tissue
#SBATCH --output=slurm_logs_tissuemnist/logits_job_%A_%a.out
...
SAVE_BASE="../MODEL_DIRECTORY/TISSUEMNIST"
