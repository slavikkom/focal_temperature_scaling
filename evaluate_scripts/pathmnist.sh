...
USE_GPU=false
SMOKE_TEST=true
SAVE_PATH="../MODEL_DIRECTORY/PATHMNIST/" # path used to save the models to use in order to lead them for evaluation
SAVE_EVAL_PATH="../RESULTS/PATHMNIST/" # path to save the evaluation results
