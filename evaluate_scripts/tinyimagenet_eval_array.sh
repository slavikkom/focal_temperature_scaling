...
# sbatch --array=0-<total_jobs> tinyimagenet_slurm_array.job

#SBATCH --job-name=eval_ti
#SBATCH --output=slurm_logs_tinyimagenet/eval_job_%A_%a.out
...
EVAL_BASE="../RESULTS/TINYIMAGENET_epoch${EPOCH}"
...
MODELS=(
  ...
  "resnet50_ti_exp_1mp"
  "resnet50_ti_exp_p"
  # "resnet50_ti_focal_loss_adaptive"
...
if [ "$DEBUG" = false ]; then
  python ../evaluate.py \
    ...
    --dataset-root ../Data/datasets/tinyimagenet \
    --model resnet50_ti \
    -log \
    $GPU_FLAG \
    $SMOKE_ARG \
