...
#SBATCH --output=slurm_logs_cifar10c_post_july17/posthoc_job_%A_%a.out
...
EVAL_BASE="../RESULTS/july26/CIFAR10C_POSTHOC_TEMPERATURE_FIRST_epoch${EPOCH}"
# EVAL_BASE="../RESULTS/july26/CIFAR10C_POSTHOC_TEMPERATURE_LAST_epoch${EPOCH}"
# EVALUATE_LINKS=(softmax focal focal_linear exp_p exp_1mp) #(all)
