#!/bin/bash
# Save OCTMNIST train/val/test logits without running post-hoc calibration.
# Submit with:
# sbatch --array=0-<total_jobs_minus_1> octmnist_save_logits_array.sh

#SBATCH --job-name=logits_oct
#SBATCH --output=slurm_logs_octmnist_lr05/logits_job_%A_%a.out
