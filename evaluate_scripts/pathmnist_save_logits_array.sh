#!/bin/bash
# Save PathMNIST train/val/test logits without running post-hoc calibration.
# Submit with:
# sbatch --array=0-<total_jobs_minus_1> pathmnist_save_logits_array.sh

#SBATCH --job-name=logits_path
#SBATCH --output=slurm_logs_pathmnist/logits_job_%A_%a.out
...
SAVE_BASE="../MODEL_DIRECTORY/PATHMNIST"
